...
def image_segmentation(image_name, image, plot_during_training=True, first_step_iter_num=4000, second_step_iter_num=8000,
                  bg_hint=None, fg_hint=None, show_every=500, downsampling_factor=0.1, downsampling_number=0):

    segment = Segmentation(image_name, image, plot_during_training=plot_during_training,
                           first_step_iter_num=first_step_iter_num, second_step_iter_num=second_step_iter_num,
                           bg_hint=bg_hint, fg_hint=fg_hint, show_every=show_every,
                           downsampling_factor=downsampling_factor, downsampling_number=downsampling_number)
    segment.optimize()
    segment.finalize()


def double_dip_segmentation(input_name, output_name, fg_hint, bg_hint, mg_flag=False, fg_mg=False, mg_bg=False,
    ...
    """
    :param input_name: file name for input image
    :param output_name: file name for output image (path to segmentation output)
    :param fg_hint: foreground hint image
    :param bg_hint: background hint image
    :param mg_flag: middle-ground hint image
    :param plot_during_training: bool for plotting progress
    :param first_step_iter_num: number of iterations in first training
    :param second_step_iter_num: number of iterations in second training
    :param show_every: show output images every ith step
    :param downsampling_factor: downsampling factor for DIPs
    :param downsampling_number: upsampling factor for DIPs
    :return: nothing
    """
    ...
    if mg_flag:
        ...
        runpy.run_module("bg_fg_prep", run_name="__main__")

    if mg_bg:
        image = cv2.imread("input/images/segmentation_" + fg_hint + "/" + input_name)
        inverted_image = cv2.bitwise_not(image)
        cv2.imwrite("input/images/segmentation_" + fg_hint + "/" + input_name, inverted_image)
    ...
    image_segmentation("images/segmentation/" + output_name, img, plot_during_training=plot_during_training,
                       first_step_iter_num=first_step_iter_num, second_step_iter_num=second_step_iter_num,
                       bg_hint=bg, fg_hint=fg, show_every=show_every, downsampling_factor=downsampling_factor,
                       downsampling_number=downsampling_number)
...
if __name__ == "__main__":
    ...
    # double_dip_segmentation("godzilla.jpg", "godzilla_landing_fb" + TIMESTAMP, "fg", "bg",
    #                         mg_flag=False, fg_mg=False, mg_bg=False,
    #                         first_step_iter_num=4000,
    #                         second_step_iter_num=8000)
    # double_dip_segmentation("godzilla.jpg", "godzilla_landing_mb" + TIMESTAMP, "mg", "bg",
    #                         mg_flag=True, fg_mg=False, mg_bg=True,
    #                         first_step_iter_num=4000,
    #                         second_step_iter_num=8000)
    # double_dip_segmentation("godzilla.jpg", "godzilla_landing_fm"+ TIMESTAMP, "fg", "mg",
    #                         mg_flag=True, fg_mg=True, mg_bg=False,
    #                         first_step_iter_num=4000,
    #                         second_step_iter_num=8000)

    # double_dip_segmentation("fg_mg_bg.jpg", "mountain_fb" + TIMESTAMP, "fg", "bg",
    #                         mg_flag=False, fg_mg=False, mg_bg=False,
    #                         first_step_iter_num=2000,
    #                         second_step_iter_num=4000)
    # double_dip_segmentation("fg_mg_bg.jpg", "mountain_mb" + TIMESTAMP, "mg", "bg",
    #                         mg_flag=True, fg_mg=False, mg_bg=True,
    #                         first_step_iter_num=2000,
    #                         second_step_iter_num=4000)
    # double_dip_segmentation("fg_mg_bg.jpg", "mountain_fm" + TIMESTAMP, "fg", "mg",
    #                         mg_flag=True, fg_mg=True, mg_bg=False,
    #                         first_step_iter_num=2000,
    #                         second_step_iter_num=4000)

    get_segmented_image("mountain", "output/images/segmentation/mountain_fb22-5-22_learned_mask.jpg",
                        "output/images/segmentation/mountain_fm11-44-11_learned_mask.jpg",
                        "output/images/segmentation/mountain_mb11-44-11_learned_mask.jpg")
